...
```{r}
maryland_population_with_voters <- maryland_population |> left_join(county_voters_2020, join_by(county))
```
...
**Task** Now let's find the county with the highest 18+ Asian population as a percentage of all population 18 and over and also the percentage of Democrats in that county. How do these results compare to the previous task? Put your answers below. **Answer: Howard County has the largest Asian 18+ population while it has a relatively low number of Democratic voters.**
