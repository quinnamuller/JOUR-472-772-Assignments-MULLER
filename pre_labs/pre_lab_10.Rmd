...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer: zip codes and the shapes they pertain to**
...
**Task** Run the following code. Describe the output in the space below. **Answer: all of the US counties with the state and other identifying data, but most improtantly the shapes of those counties**
...
**Task** Run the following code. Describe the output in the space below. **Answer: gives the same as before but with only the counties in maryland**
...
**Task** Run the following code. Describe the output in the space below. **Answer: it gives a map of the maryland counties**
...
**Task** Run the following code. Describe the output in the space below. **Answer: it shows the map of amryland counties overlayed by the maryland zip codes**
...
**Task** Run the following code. Describe the output in the space below. **Answer: it joins the foreclosures data with the maryalnd zip codes data**
