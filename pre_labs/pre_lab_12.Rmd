...
**Task** Run the following code and describe the dataframe it outputs. **Answer: The output shows various instances of disciplinary taken against a doctor. Each entry shows the name of the doctor, the date/year, action type, and the text from the case, among other things. **
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer: It takes all of the unique entries from the list.**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer: It shows all the words, singularly, in the text value.**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer: Not really, it's what you'd expect. You'd expect words like "the" and "of" to be the most common words in the dataset. Respondent was a bit of an oddity but since it's a disciplinary case, this makes sense. The same goes fro "patient," "board" and "panel."**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer: A lot of the words are still kind of what you'd expect to see in a medical disciplinary case, but it's definitely more interesting and representative than "the" and "of." I'm really wondering who Ann is that she got mentioned 1772 times though**
...
**Task** Run the following code and describe the results. **Answer: They pretty much show the quintessential words you'd expect to see in a medical disciplinary report.**
...
**Task** Run the following code and describe the results. **Answer: This shows counts of two-word phrases in these disciplinary reports. I am just now unfortunately learning that ann is short for annotation and I'm honestly disappointed, I thought this was gonna be a weird story. It makes sense that "ann" was so common especially since it is included in two of these bigrams.**
...
**Task** Run the following code and describe the results. **Answer: The results are all identical.**
...
**Task** Run the following code and describe the results. **Answer: This shows the top 10 two word phrases for 2024, which are the pretty much the same as from 2023.**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer: Yes. I think that the word patient, medically, is not really positive, but the word patient as an adjective is. The word right is also probably referring not to right vs left or right vs wrong but refers to someones rights, which is probably neutral. Also, contextually, these are probably all not very positive situations.**
