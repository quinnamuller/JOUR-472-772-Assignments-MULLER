...
**Answer: It shows all of the aforementioned political and financial factors for each state in 2020/2021.**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer: There is a slightly positive correlation between GDP growth and population growth.**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer: The relationship between per pupil spending and GDP growth is very slightly negative, so much so that it is likely insignificant.**
...
#Trauma flashbacks to my sophomore year 8 a.m. ecology lab...
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer: The correlation between population change and per pupil expenses is the most significant with a negative correlation of 0.41. The relationship between GDP growth and per pupil expenses seems incredibly insignificant, as it's nearly 0.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: There are a lot of values that came out of it that I don't really completely understand but the p-value seems pretty low.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: The p-value for this relationship is significantly higher.**
...
**Task** Run the following code. Describe the table. What do you see? **Answer: The dataframe summarizes the statistics for states who voted for  Biden and states who votes for Trump. States that voted for Biden had a higher mean GDP growth and investment in students, while states that voted for Trump had a higher population growth.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: The p-value is higher than but pretty close to 0.05 which implies that this may not be a statistical coincidence.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: The p-value here is much lower and the t-value is much stronger, implying a much higher statistical significance between per pupil expenses and votes for Trump/Biden.**
